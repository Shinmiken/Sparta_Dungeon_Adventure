...
public class Interaction : MonoBehaviour
{
    ...
    public bool CheckLadder() // ªÁ¥Ÿ∏Æ »Æ¿ŒøÎ ∑π¿Ã
    {
    ...
    void CheckInfo()
    {
        ...
        if (Physics.Raycast(ray, out hit, maxCheck, layerMask)) // ∑π¿Ã ΩÓ±‚
        {
    ...
    private void SetPromptText() // ¿Â¬¯ «•Ω√
    {
        promptText.gameObject.SetActive(true);
        promptText.text = discripsion;
    }

    public void OnInteractInput(InputAction.CallbackContext context) // æ∆¿Ã≈€ »πµÊ ¥‹√‡≈∞ Ω««‡
    {
